...
async function start() {
    ...
    await awesome_page.goto('https://mae-something-awesome.netlify.app', {waitUntil: 'networkidle2'});
    await awesome_page.click('#root > div.navigation > div > div > ul > li:nth-child(1)')
    await awesome_page.waitForTimeout(2000)
    ...
    await page.type('input[type="email"]', "mae.something.awesome@gmail.com", {delay: 11});
    ...
    await page.type('input[type="password"]', "mae.something.", {delay: 11});
    await page.keyboard.press('Enter')
    ...
    await awesome_page.waitForTimeout(8000)
    await browser.close()
  //await browser.close()
}
